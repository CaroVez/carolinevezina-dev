  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-40 right-6 z-30 p-3 rounded-full shadow-lg transition-all duration-500 border text-[#479796] border-[#479796] bg-[#f2f2f2]/60 backdrop-blur-md hover:border-[#ba7954] hover:bg-[#ba7954] hover:text-white hover:border-[#ba7954] cursor-pointer group 
